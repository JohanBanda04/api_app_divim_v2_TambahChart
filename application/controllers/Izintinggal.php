...
class Izintinggal extends CI_Controller
{
    ...
    public function getDataByNoPaspor($no_paspor) //parameter didapet dari url
    {
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'GET' || $this->uri->segment(3) == '') {
            ...
            if ($check_auth_client == true) {
                $response = $this->MyModel->auth();
                if ($response['status'] == 200) {
                    $resp = $this->MyModel->getDataByNoPaspor($no_paspor,$this->table_name);
                    json_output($response['status'], $resp);
                }
            }
        }
    ...
    public function izintinggalByZona($zona_id) //parameter didapet dari url
    {
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'GET' || $this->uri->segment(3) == '') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                $response = $this->MyModel->auth();
                if ($response['status'] == 200) {
                    $resp = $this->MyModel->izintinggalByZona($zona_id,$this->table_name);
                    json_output($response['status'], $resp);
                }
            }
        }
    ...
    public function izintinggalByZonaAndStatus($zona_id,$status) //parameter didapet dari url
    {
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'GET' || $this->uri->segment(3) == '') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                $response = $this->MyModel->auth();
                if ($response['status'] == 200) {
                    $resp = $this->MyModel->izintinggalByZonaAndStatus($zona_id,$this->table_name,$status);
                    json_output($response['status'], $resp);
                }
            }
        }
    ...
    public function izintinggalByZonaAndNotStatus($zona_id,$status) //parameter didapet dari url
    {
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'GET' || $this->uri->segment(3) == '') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                $response = $this->MyModel->auth();
                if ($response['status'] == 200) {
                    $resp = $this->MyModel->izintinggalByZonaAndNotStatus($zona_id,$this->table_name,$status);
                    json_output($response['status'], $resp);
                }
            }
        }
    ...
    public function izintinggalAllForCount() //parameter didapet dari url
    {
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'GET' || $this->uri->segment(3) == '') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                $response = $this->MyModel->auth();
                if ($response['status'] == 200) {
                    $resp = $this->MyModel->izintinggalAllForCount($this->table_name);
                    json_output($response['status'], $resp);
                }
            }
        }
    ...
    public function izintinggalByStatusandZonaID($zona_id,$status) //parameter didapet dari url
    {
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'GET' || $this->uri->segment(3) == '') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                $response = $this->MyModel->auth();
                if ($response['status'] == 200) {
                    $resp = $this->MyModel->izintinggalByStatusandZonaID($zona_id,$status,$this->table_name);
                    json_output($response['status'], $resp);
                }
            }
        }
    ...
    public function izintinggalAllByStatus($status) //parameter didapet dari url
    {
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'GET' || $this->uri->segment(3) == '') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                $response = $this->MyModel->auth();
                if ($response['status'] == 200) {
                    $resp = $this->MyModel->izintinggalAllByStatus($status,$this->table_name);
                    json_output($response['status'], $resp);
                }
            }
        }
